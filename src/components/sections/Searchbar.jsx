...
export const Searchbar = ({
  ...
  return (
    <motion.div
      className="max-w-full w-full mx-auto bg-white rounded-l-sm rounded-r-sm shadow-lg flex flex-wrap items-center"
      style={{
    ...
    >
      ...
      <div className="flex items-center justify-center ml-4">
        ...
        <motion.button
          ...
          className="bg-[#8247E5] hover:bg-[#A673EF] text-xl w-[100px] text-white transition-colors duration-300 h-full rounded-r-md font-semibold"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
