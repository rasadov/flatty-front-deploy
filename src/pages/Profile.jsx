...
export const Profile = () => {
  ...
  const fetchProfile = async () => {
      fetch("https://flatty.abyssara.tech/api/v1/auth/refresh", {
        method: "POST",
        credentials: "include",
      })
      .then((res) => {
      ...
      const response = await fetch("https://flatty.abyssara.tech/api/v1/user/me/agent", {
      headers: {
      ...
      const response2 = await fetch("https://flatty.abyssara.tech/api/v1/property/agent/" + data.id + "/page", {
      headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
      credentials: 'include',
      ...
      const response3 = await fetch("https://flatty.abyssara.tech/api/v1/listing/me", {
      headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
      credentials: 'include',
