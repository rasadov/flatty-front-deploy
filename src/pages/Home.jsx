      ...
      <div className="px-16 mx-auto max-w-[1440px]">
        ...
        <div className="relative z-10 md:-mt-40">
          <CardList sectionName="Featured" seeAll={true}>
            {Array.isArray(featuredProperties.properties) && featuredProperties.properties.length > 0 ? (
        ...
        <CardList sectionName="Popular" seeAll={true}>
          {Array.isArray(popularProperties.properties) && popularProperties.properties.length > 0 ? (
