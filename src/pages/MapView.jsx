...
export default function MapView() {
  ...
  <div className="flex items-center justify-center w-full gap-4 my-12 px-4 md:px-16">
    <Searchbar
  ...
  <div className="flex flex-col lg:flex-row h-screen overflow-y-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-500">
    ...
    {selectedProperties.length > 0 ? (
      <div
        className="w-full lg:w-[300px] border-r border-gray-300 overflow-y-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-500"
      >
