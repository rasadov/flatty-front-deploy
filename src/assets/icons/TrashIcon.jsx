...
export const Active = () => {
    return (
        ...
        <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_1204_13683"/>
        <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1204_13683" result="shape"/>
        </filter>
        </defs>
        </svg>
    );
